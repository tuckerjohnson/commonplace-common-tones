...
hnMusic = \relative { \key c \major \numericTimeSignature
  ...
  R1*3/4 |\bh %125
  R1*3/4 |%126
  fis8(\pp c8 cis8 g'8 e8 fis8 |%127
  gis8 c,8 d8 a'8 dis,8 b'8) |%128
  R1*3/4 |%129
  R1*3/4 |\bh %130
  ...
  \time 4/4 a8->[ g8~->] 8 r8 r2 |%152
  \time 5/8 cis4~-> 4. |%153
  \time 3/4 f8-> r8 r4 r4 |%154
  \time 4/4 b,2.-> f4~-> |\bh %155
